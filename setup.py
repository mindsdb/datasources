...
about = {}
with open("mindsdb_datasources/__about__.py") as fp:
    exec(fp.read(), about)
...
with open('optional_requirements_scylla.txt', 'r') as fp:
    for line in fp:
        scylla_requirements.append(line.rstrip('\n'))

cassandra_requirements = []
with open('optional_requirements_cassandra.txt', 'r') as fp:
    for line in fp:
        cassandra_requirements.append(line.rstrip('\n'))
